...
<form id="register_form" method="post" action="/user/login" >
    ...
    <div id="bd">
        ...
        <div class="shadow_box">
            <div class="register_box">
                <div class="head">
                    <span class="dd_more"><a href="index.jsp" class="home">xun书首页</a><a href=""> 登录帮助</a></span>
                    <a href="login.jsp" class="head_a">密码登录</a>
                    <a href="javascript:void(0);" class="head_a head_a1">验证码</a>
                </div>
                ...
                <div class="body">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td class="t">手机号码</td>
                            <td class="z_index2">
                                <input name="PhoneNum" id="PhoneNum" autocomplete="off" MaxLength="40"
                        ...
                        <tr>
                            ...
                            <td class="j-vcode">
                                ...
                                <input class="text pin" type="text" id="CheckCode" name="CheckCode" autocomplete="off" placeholder="请输入手机验证码" MaxLength="6" tabindex="5"/>
...
<%--                                <a id="vcodeImgBtn" name="change_code_link" class="code_picww" href="javascript:void(0);" >换张图</a>--%>
                                <button type="button"  style="width:120px;height:37px;" id="checkbtn" onclick="check1(0)" >发送验证码</button>
                        ...
                        <tr>
                            <td class="t">&nbsp;</td>
                            <td><button id="J_submitRegister"  class="btn_login" tabindex="10">立即登录</button><a id="J_submitRegisterUnclick" style="display: none;" class="btn_login">登录中...</a></td>
                        </tr>
                    </table>
                </div>
            </div>
