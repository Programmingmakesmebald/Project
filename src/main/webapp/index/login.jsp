...
<div class="ddnewhead_wrap">
    <div class="ddnewhead_content ddnewhead_content2">
        ...
        <div class="ddnewhead_logo"><a href="/index/index.jsp" title="返回首页" name="ddnav_logo">
            <img src="/index/images/102.png" alt="xun书"/></a></div>
        <div class="clear"></div>
    </div>
...
<form id="register_form" method="post" action="/user/login" onsubmit="">
        ...
        <div class="shadow_box">
            <div class="register_box">
                <div class="head">
                    ...
                    <a href="javascript:void(0);" class="head_a head_a1">密码登录</a>
                    <a href="/index/login1.jsp" class="head_a">验证码登录</a>
                </div>
                ...
                <div class="body">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td class="t">手机号码</td>
                            <td class="z_index2">
                                <input name="PhoneNum" id="txt_username" autocomplete="off" MaxLength="40"
                        ...
                        <tr>
                            <td class="t">登录密码</td>
                            <td>
                                <input name="LPassword" id="txt_password" onpaste="return false;" tabindex="2" type="password" class="text" MaxLength="20" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="t">&nbsp;</td>
                            <td><button id="J_submitRegister" href="javascript:void(0);" class="btn_login" tabindex="10">立即登录</button><a id="J_submitRegisterUnclick" style="display: none;" class="btn_login">登录中...</a></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<script type="text/javascript" src="script/login/signIn_160802.js?20160802" ></script>
